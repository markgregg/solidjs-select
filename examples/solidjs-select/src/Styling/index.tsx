  ...
  return (
    <div class='started'>
      <div>
        ...
        <h3 class='no-space-after'>Style Properties</h3>
        <h4 class='no-space-after'>Main</h4>
        <ul class='style-list'>
          <li>toolTipComponent</li>
          <li>choiceComponent</li>
          <li>displayComponent</li>
          <li>style?</li>
          <li>selectStyle</li>
          <li>selectDisabledStyle</li>
          <li>className</li>
          <li>disabledClassName</li>
          <li>inputStyle</li>
          <li>inputDisabledStyle</li>
          <li>inputClassName</li>
          <li>inputDisabledClassName</li>
          <li>clearSelectionStyle</li>
          <li>clearSelectionDisabledStyle</li>
          <li>clearSelectionClassName</li>
          <li>clearSelectionDisabledClassName</li>
          <li>choiceListStyle</li>
          <li>choiceListClassName</li>
          <li>dropdownIconStyle</li>
          <li>dropdownIconDisabledStyle</li>
          <li>dropIconClassName</li>
          <li>dropIconDisabledClassName</li>
          <li>hideDropdownIcon</li>
          <li>dropdownIcon</li>
          <li>clearSelectionIcon</li>
          <li>hideTitle</li>
          <li>height</li>
          <li>minHeight</li>
          <li>maxHeight</li>
        ...
        <ul class='style-list'>
          <li>choiceStyle</li>
          <li>choiceSelectedStyle</li>
          <li>choiceHoverStyle</li>
          <li>choiceDisabledStyle</li>
          <li>choiceClassName</li>
          <li>choiceSelectedClassName</li>
          <li>choiceDisabledClassName</li>
          <li>choiceHoverClassName</li>
          <li>choiceSelectedIconStyle</li>
          <li>choiceSelectedIconClassName</li>
          <li>choiceSelectedIcon</li>
          <li>selectionType</li>
        </ul>
        <h4 class='no-space-after'>Display</h4> 
        <ul class='style-list'>
          <li>displayStyle</li>
          <li>displayDisabledStyle</li>
          <li>displayClassName</li>
          <li>displayDisabledClassName</li>
        </ul>
        <h4 class='no-space-after'>Title</h4> 
        <ul class='style-list'>
          <li>titleStyle</li>
          <li>titleDisabledStyle</li>
          <li>titleClassName</li>
          <li>titleDisabledClassName</li>
        </ul>
        <h4 class='no-space-after'>ToolTip</h4> 
        <ul class='style-list'>
          <li>toolTipClassName</li>
          <li>toolTipStyle</li>
          <li>toolTipPosition</li>
        </ul>
        ...
        <ul class='style-list'>
          ...
          <li>--solidjsSelectSelectedChoiceBackgroundColor</li>
